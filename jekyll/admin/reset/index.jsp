...
<%
  if (request.getAttribute("isForwordedRequest") == null) {
    request.getRequestDispatcher("/admin/reset/").forward(request, response);
    return;
  }
%>
...
<div class="jumbotron bg-danger">
  <div class="panel panel-default">
    <div class="panel-heading">
      <h1 class="panel-title">Reset <i class="fa fa-bolt text-danger"></i></h1>
    </div>
...
<!-- Modal -->
<div class="modal fade bg-danger" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer bg-danger">
        <p class="help-block text-left">If you still want to continue, type 'Reset' in the text field below and press Reset.</p>
        <form action="/admin/reset/" method="post" class="form-horizontal" role="form">
          <div class="input-group">
            ...
            <span class="input-group-btn">
              <input type="submit" class="btn btn-danger col-sx-12" value="Reset" />
            </span>
          </div>
        </form>
      </div>
