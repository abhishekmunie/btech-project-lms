...
<div id="dev-warnng" class="alert alert-warning alert-dismissable">
  ...
  <a href="/no-project-warning?redirect=<%=Utilities.urlEncodeUTF8(request.getRequestURI().replaceAll("/index.jsp", "/")+((request.getQueryString() != null) ? "?" + request.getQueryString() : ""))%>" class="alert-link pull-right" >Dont show again</a>
